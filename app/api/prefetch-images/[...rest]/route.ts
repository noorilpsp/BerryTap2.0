...
export async function GET(
  ...
  // Try main img first, fallback to all img if no main tag exists
  let imgElements = Array.from(document.querySelectorAll("main img"));
  ...
  const images = imgElements
    ...
    .filter((img) => img.src && !img.src.includes("favicon"));
